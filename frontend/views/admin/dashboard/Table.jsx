...
import { useFetchAllOrderQuery } from '../../redux/feature/orderAPI';
...
export default function DataTable() {
  ...
  const {data : {rows = []} = [], isLoading} = useFetchAllOrderQuery();
                      ...
                      {columns.map((column) => {
                        ...
                        return (
                          <TableCell key={column.id} align={column.align}>
                            {column.id === "price" ? (<Currency amount={value}/>) : column.id === "_id" ? index + 1 : value}
                          </TableCell>
                        );
                      })}
                    </TableRow>
