...
const AdminProducts = () => {
    ...
    const handleModifyClick = (product) => {
        setSelectedProduct(product); // Set the product to be modified
        setIsFormOpen(true); // Open the form
    };

    const handleAddProductClick = () => {
        setSelectedProduct(null); // Reset selected product for new product
        setIsFormOpen(true); // Open the form for adding a new product
    };
